...
const Welcome = () => {
  ...
  <ul className="grid mt-6 md:grid-cols-2 bg-white mx-16  ">
                <li className='max-w-md m-auto'>
                    <p className='text-6xl font-bold'>Welcome to our Restoran Blog</p>
                    <hr className="h-px my-2 bg-slate-900 border-0 dark:bg-gray-700"/>
                    ...
                    Start reading 
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="pl-2 size-6">
...
<ul class="grid mb-8 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2 bg-white dark:bg-gray-800">
...
<ul class="w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
